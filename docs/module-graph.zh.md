...
| [`client-ui-settings-plugin-marketplace`](../packages/client/ui-settings-plugin-marketplace) | `client` | — |
...
| [`host-plugin-marketplace-github`](../packages/host/plugin-marketplace-github) | `host` | [`brand`](../packages/util/brand), [`typert-protocol`](../packages/typert/protocol) |
