...
Source: [`packages/subagent/agent-cli/src/index.ts:24`](../packages/subagent/agent-cli/src/index.ts)
...
Source: [`packages/subagent/crew/src/types.ts:381`](../packages/subagent/crew/src/types.ts)
