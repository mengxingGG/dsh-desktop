...
| [crew.md](crew.md) | native software Crew: versioned work items, scoped workers, host verification, independent review, integration, recovery, notification, and approved local commit |
