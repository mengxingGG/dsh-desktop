...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/client/ui-settings-plugin-marketplace': { kind: 'none', reason: 'Browser-side marketplace controls; registers nothing model-facing.' },
  'packages/host/plugin-marketplace-github': { kind: 'none', reason: 'Host Remote for repository discovery and profile installation; registers nothing model-facing.' },
