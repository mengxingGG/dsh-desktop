...
def main() -> None:
    ...
    parser.add_argument(
        "--scenario",
        choices=("all", "sdk-default", "sdk-custom", "sdk-minimal", "sdk-fs-search", "sdk-spawn-node", "sdk-mcp", "sdk-snapshot", "sdk-crew-snapshot", "sdk-restart", "sdk-profile-plugin", "sdk-live", "runner", "direct"),
        default="all",
    )
    ...
    if args.scenario in {"all", "sdk-custom", "sdk-minimal", "sdk-fs-search", "sdk-spawn-node", "sdk-snapshot", "sdk-crew-snapshot", "sdk-restart", "runner", "direct"} and args.exe is None:
