...
export const SERVICE_PAGE: Record<string, string> = {
  ...
  crew: 'crew.md',
  crewPreferences: 'crew.md',
  crewProfilePresets: 'crew.md',
...
export const SERVICE_WALK_EXEMPTIONS: Record<string, string> = {
  ...
  chatDetails: 'client-side typed details-column controller — packages/client/ui-chat/README.md owns the API',
...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  AppendCrewWorkRequest: 'crew.md',
  CreateCrewWorkItemRequest: 'crew.md',
  CrewAgentOptionsSnapshot: 'crew.md',
  CrewConfigurationSnapshot: 'crew.md',
  CrewFileEntry: 'crew.md',
  CrewFileRead: 'crew.md',
  CrewIntegrationSnapshot: 'crew.md',
  CrewMutationResult: 'crew.md',
  CrewMemoryEntry: 'crew.md',
  CrewMemoryId: 'crew.md',
  CrewPreferencesSnapshot: 'crew.md',
  CrewPreferencesValue: 'crew.md',
  CrewProjectionState: 'crew.md',
  CrewProfilePresets: 'crew.md',
  CrewReportSnapshot: 'crew.md',
  CrewRole: 'crew.md',
  CrewTestRun: 'crew.md',
  CrewView: 'crew.md',
  CrewWorkerBinding: 'crew.md',
  CrewWorkItemSnapshot: 'crew.md',
  DispatchCrewWorkRequest: 'crew.md',
  IntegrateCrewRequest: 'crew.md',
  ReassignCrewWorkRequest: 'crew.md',
  RecordCrewReportRequest: 'crew.md',
  StopCrewWorkRequest: 'crew.md',
  UpdateCrewWorkItemRequest: 'crew.md',
  ...
  SubagentSettlementNoticeInfo: 'subagent.md',
