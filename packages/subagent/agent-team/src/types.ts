...
import type { AgentOptions } from '@deepseek-ai/dsh-agent/types'
...
export interface SpawnTeammateRequest {
  ...
  /** Optional host-owned provenance retained on the child's initial prompt. */
  readonly promptSource?: MessageSource
  readonly context: 'fresh' | 'fork'
  readonly provider: string
  /** Optional child model-route overrides persisted by the continuation owner. */
  readonly agentOptions?: AgentOptions
  /** Optional child persona persisted and reapplied on cold resume. */
  readonly persona?: string
  /** Optional child tool composition persisted and reapplied on cold resume. */
