...
export const CLIENT_SLOT_API: readonly ClientSlotEntry[] = [
  ...
  },
  {
    ...
    occupants: [
      ...
      'client-ui-claude-code UsageBar id \'claude-usage\'',
    ],
    replaceRisk: 'none',
  ...
  },
  {
    ...
    occupants: [
      ...
      'client-ui-settings-plugin-marketplace MarketplaceTab id \'marketplace\'',
  ...
  },
  {
    ...
    occupants: [
      ...
      'client-ui-claude-code AccountSection id \'claude-code\'',
  ...
  },
  {
    ...
    keyDomain: 'open: any string the owner dispatches (no compile-time key set), already taken: @deepseek-ai/dsh-client-ui-crew',
    ...
    occupants: [
      'client-ui-crew CrewSidebarView key \'@deepseek-ai/dsh-client-ui-crew\'',
