...
The panel toggle uses state-driven Morphicons transitions. Controls preserve the expanded and collapsed layout with consistent spacing and visible keyboard focus.
