...
Unlocking or switching a Session focuses the composer without scrolling unless a modal outside the composer holds focus. That modal keeps the user's editing focus when a pending Session finishes opening ([decision](../../../.agents/notes/implemented/bug-fix/2026-09-05-composer-autofocus-respects-modal-focus.md)).
