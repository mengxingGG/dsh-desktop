...
解锁或切换 Session 时，composer 会在不滚动页面的情况下取得焦点，但如果焦点位于 composer 之外的模态窗口中，则保留该焦点。即使等待中的 Session 完成打开，模态窗口也保留用户的编辑焦点（[决策](../../../.agents/notes/implemented/bug-fix/2026-09-05-composer-autofocus-respects-modal-focus.zh.md)）。
