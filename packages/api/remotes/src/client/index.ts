...
import pluginMarketplaceRemote from '@deepseek-ai/dsh-host-plugin-marketplace-github/remote'
...
// dsh-desktop: GitHub plugin marketplace client contribution (community downstream).
export type {
  MarketplaceEntry,
...
} from '@deepseek-ai/dsh-host-plugin-marketplace-github/types'
...
export async function apply(ctx: Context): Promise<() => Promise<void>> {
  ...
  try {
    for (const contribution of [
      ...
      pluginInventoryRemote, pluginMarketplaceRemote, messageFeedbackRemote, sessionReferencesRemote,
